...
export default function Teachers() {
    ...
    const { data, loading, error, currentPage, totalPages, totalData, searchTerm, isModalOpen, isEdit, formData, isRfidModalOpen, rfidData } = state;
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={actions.openAddModal} className="flex items-center gap-2 rounded-lg bg-blue-600 py-2 px-4 text-white hover:bg-blue-700 transition shadow-sm font-medium text-sm">
                    ...
                    <div className="w-full max-w-lg rounded-xl bg-white p-8 shadow-2xl dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
                        ...
                        <form onSubmit={actions.handleSubmit}>
                            <div className="space-y-4">
                                <input type="text" name="name" value={formData.name} onChange={actions.handleChange} required placeholder="Nama Lengkap" className="w-full rounded-lg border border-gray-300 bg-transparent py-2.5 px-4 text-sm outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white" />
                                <input type="text" name="nip" value={formData.nip} onChange={actions.handleChange} placeholder="NIP" className="w-full rounded-lg border border-gray-300 bg-transparent py-2.5 px-4 text-sm outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white" />
                                <input type="email" name="email" value={formData.email} onChange={actions.handleChange} required placeholder="Email" className="w-full rounded-lg border border-gray-300 bg-transparent py-2.5 px-4 text-sm outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white" />
                                <select name="jenis_kelamin" value={formData.jenis_kelamin} onChange={actions.handleChange} className="w-full rounded-lg border border-gray-300 bg-transparent py-2.5 px-4 text-sm outline-none dark:border-gray-600 dark:bg-gray-900 dark:text-white">
                                    <option value="L">Laki-laki</option>
                                    <option value="P">Perempuan</option>
                                </select>
                            </div>
                            <div className="flex justify-end gap-3 mt-8">
                                <button type="button" onClick={() => actions.setIsModalOpen(false)} className="rounded-lg bg-gray-100 py-2.5 px-5 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300">Batal</button>
